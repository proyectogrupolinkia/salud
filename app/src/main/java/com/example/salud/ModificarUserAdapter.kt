...
class ModificarUserAdapter(private var users: List<User>, private val onEditClick: (User) -> Unit) : RecyclerView.Adapter<ModificarUserAdapter.UserViewHolder>() {


    class UserViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        val textView: TextView = view.findViewById(R.id.tvNameModificar)
        val textView2: TextView = view.findViewById(R.id.tvCorreoModificar)
...
//        val textView5: TextView = view.findViewById(R.id.tvAltura)
        val btnConsultar: Button =view.findViewById(R.id.btnConsultarModificar)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UserViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_usermodificar, parent, false)
